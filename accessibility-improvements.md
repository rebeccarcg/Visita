...
- **Recommendation:** Make link text more descriptive so it's clear where the link leads, even out of context.
  ...
  - Example:
    ...
    <!-- Before -->
    <a
      class="Texteditor__link"
      data-password="true"
      href="https://visita.se/swedbank-pay/"
      target="_blank"
    >
      Läs mer här!
    </a>
    ...
    <a
      ...
      href="https://visita.se/swedbank-pay/"
      target="_blank"
      aria-label="Läs mer om Swedbank Pay kortinlösen"
    >
      Läs mer här!
    </a>
    ```
...
- **Recommendation:** Ensure the "restricted" meaning is conveyed to screen readers.
  ...
  - Example:
    ...
    <a
      class="nav-link"
      href="https://visita.se/nyhetsbrev/"
      aria-label="Nyhetsbrev (members only)"
      >Nyhetsbrev<i class="fo-icon-lock" aria-hidden="true"></i
    ></a>
    ```
...
- **Recommendation:**
  ...
  - Example for search overlay close:
    ...
    ```html
    <!-- Before -->
    <div data-toggle="search-overlay" class="Search-overlay__close">
      <i class="fo-icon-close"></i>
    </div>
  ...
  - Example for slider buttons:
    ...
    <button
      data-button="prev"
      class="external__button fo-icon-chevron"
    ></button>
